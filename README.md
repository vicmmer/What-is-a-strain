...
To run it, download the StatsAnysis.R code onto a directory in your computer that also contains the following files: SRR26772099.tsv, SRR26772116.tsv and mixed.tsv  
